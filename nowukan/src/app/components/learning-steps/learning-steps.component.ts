...
export class LearningStepsComponent {
  ...
  readonly steps: Step[] = [
    ...
    { n: 4, label: 'Words', img: 'assets/explain/word-speedometer.png' },
    { n: 5, label: 'Phrases', img: 'assets/explain/phrases-ticket.png' },
    { n: 6, label: 'Dialogue', img: 'assets/img/img-a808eb8bdb.jpeg' },
    { n: 7, label: 'QuickFire', img: 'assets/img/img-c8fe49600d.jpeg' },
    { n: 8, label: 'Progress & Completion', img: 'assets/explain/quickfire-results.png' },
  ];
}
