      ...
      <div class="container journey-layout">
        <div class="journey-copy prose">
          ...
          <ul>
            ...
            <li>Storage:<br />[confirm minimum free storage]</li>
            <li>RAM:<br />[confirm minimum RAM]</li>
            <li>Screen size:<br />[confirm minimum screen size]</li>
          </ul>
        ...
        <div class="journey-visual">
          ...
          <div class="icon-badge-label" style="text-align:center">Works Offline<br />After Install</div>
        </div>
      </div>
    </section>
  `,
