    ...
    <section class="page-shell">
      <div class="container journey-layout">
        <div class="journey-copy prose">
          ...
          <p>
            Connect with another user via Bluetooth, choose your challenge, and compete
            head-to-head.
          </p>
          <p>
            The Challenge compares your overall performance to determine who demonstrates the
            stronger pronunciation, understanding and English language skills.
          </p>
