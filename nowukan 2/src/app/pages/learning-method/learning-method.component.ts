      ...
      <div class="container journey-layout">
        <div class="journey-copy prose">
          ...
          <p>
            ...
            teaching language you are unlikely to use.
          </p>
          <p>
            Our approach helps you develop practical vocabulary, strengthen your overall
            language skills, and build the confidence to use English in real world situations.
          </p>
          <p>
